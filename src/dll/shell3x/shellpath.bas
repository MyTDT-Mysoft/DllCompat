...
static shared kcMap(MAX_KFID-1) as kcmItem = {_
  ...
  (@FOLDERID_CDBurning,                   CSIDL_CDBURN_AREA),_
  ...
  (@FOLDERID_CommonPrograms,              CSIDL_COMMON_PROGRAMS),_
  (@FOLDERID_CommonStartMenu,             CSIDL_COMMON_STARTMENU),_
  (@FOLDERID_CommonStartup,               CSIDL_COMMON_STARTUP),_ 'CSIDL_COMMON_ALTSTARTUP
  (@FOLDERID_CommonTemplates,             CSIDL_COMMON_TEMPLATES),_
  (@FOLDERID_ComputerFolder,              CSIDL_DRIVES),_
  ...
  (@FOLDERID_Cookies,                     CSIDL_COOKIES),_
  (@FOLDERID_Desktop,                     CSIDL_DESKTOP),_ 'CSIDL_DESKTOPDIRECTORY
  (@FOLDERID_DeviceMetadataStore,         NOWHERE),_
  (@FOLDERID_Documents,                   CSIDL_MYDOCUMENTS),_ 'CSIDL_PERSONAL
  (@FOLDERID_DocumentsLibrary,            NOWHERE),_
  (@FOLDERID_Downloads,                   NOWHERE),_
  (@FOLDERID_Favorites,                   CSIDL_FAVORITES),_ 'CSIDL_COMMON_FAVORITES
  (@FOLDERID_Fonts,                       CSIDL_FONTS),_
  ...
  (@FOLDERID_InternetCache,               CSIDL_INTERNET_CACHE),_
  ...
  (@FOLDERID_Music,                       CSIDL_MYMUSIC),_
  ...
  (@FOLDERID_Pictures,                    CSIDL_MYPICTURES),_
  ...
  (@FOLDERID_ProgramFiles,                CSIDL_PROGRAM_FILES),_
  (@FOLDERID_ProgramFilesCommon,          CSIDL_PROGRAM_FILES_COMMON),_
  (@FOLDERID_ProgramFilesCommonX64,       NOWHERE),_
  (@FOLDERID_ProgramFilesCommonX86,       CSIDL_PROGRAM_FILES_COMMONX86),_
  (@FOLDERID_ProgramFilesX64,             NOWHERE),_
  (@FOLDERID_ProgramFilesX86,             CSIDL_PROGRAM_FILESX86),_
  (@FOLDERID_Programs,                    CSIDL_PROGRAMS),_
  (@FOLDERID_Public,                      NOWHERE),_
  (@FOLDERID_PublicDesktop,               CSIDL_COMMON_DESKTOPDIRECTORY),_
  (@FOLDERID_PublicDocuments,             CSIDL_COMMON_DOCUMENTS),_
  (@FOLDERID_PublicDownloads,             NOWHERE),_
  (@FOLDERID_PublicGameTasks,             NOWHERE),_
  (@FOLDERID_PublicLibraries,             NOWHERE),_
  (@FOLDERID_PublicMusic,                 CSIDL_COMMON_MUSIC),_
  (@FOLDERID_PublicPictures,              CSIDL_COMMON_PICTURES),_
  (@FOLDERID_PublicRingtones,             NOWHERE),_
  (@FOLDERID_PublicVideos,                CSIDL_COMMON_VIDEO),_
  ...
  (@FOLDERID_RecycleBinFolder,            CSIDL_BITBUCKET),_
  (@FOLDERID_ResourceDir,                 CSIDL_RESOURCES),_
  (@FOLDERID_Ringtones,                   NOWHERE),_
  (@FOLDERID_RoamingAppData,              CSIDL_APPDATA),_
  ...
  (@FOLDERID_Templates,                   CSIDL_TEMPLATES),_
  ...
  (@FOLDERID_Videos,                      CSIDL_MYVIDEO),_
